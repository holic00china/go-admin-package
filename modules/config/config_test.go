...
func TestUpdate(t *testing.T) {
	m := map[string]string{
		...
		"custom_500_html":                   "",
		"custom_foot_html":                  "",
		"custom_head_html":                  ` <link rel="icon" type="image/png" sizes="32x32" href="//quick.go-admin-package.cn/official/assets/imgs/icons.ico/favicon-32x32.png">`,
		...
		"plugin_file_path":                  `/go/src/go-admin-package/examples/gin/plugins.go`,
