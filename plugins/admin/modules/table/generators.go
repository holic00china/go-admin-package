...
import (
	...
	"go-admin-package/modules/collection"
	"go-admin-package/modules/config"
	"go-admin-package/modules/db"
	"go-admin-package/modules/db/dialect"
	errs "go-admin-package/modules/errors"
	"go-admin-package/modules/language"
	"go-admin-package/modules/logger"
	"go-admin-package/modules/ui"
	"go-admin-package/modules/utils"
	"go-admin-package/plugins/admin/models"
	form2 "go-admin-package/plugins/admin/modules/form"
	"go-admin-package/plugins/admin/modules/parameter"
	"go-admin-package/plugins/admin/modules/tools"
	"go-admin-package/template"
	"go-admin-package/template/types"
	"go-admin-package/template/types/action"
	"go-admin-package/template/types/form"
	selection "go-admin-package/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "go-admin-package/modules/db/dialect", Value: "go-admin-package/modules/db/dialect"},
			{Text: "go-admin-package/modules/db", Value: "go-admin-package/modules/db"},
			{Text: "go-admin-package/modules/language", Value: "go-admin-package/modules/language"},
			{Text: "go-admin-package/modules/logger", Value: "go-admin-package/modules/logger"},
		}).
		FieldDefault("").
