...
import (
	...
	errors2 "go-admin-package/modules/errors"
	...
	"go-admin-package/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://go-admin-package/blob/master/template/login/theme1.tmpl#L32
	// https://go-admin-package/blob/master/template/login/list.go
	GetAssetList() []string
